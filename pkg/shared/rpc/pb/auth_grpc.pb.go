...
type AuthClient interface {
	...
	Register(ctx context.Context, in *RegisterEmail, opts ...grpc.CallOption) (*AuthResponse, error)
}
...
func (c *authClient) Register(ctx context.Context, in *RegisterEmail, opts ...grpc.CallOption) (*AuthResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuthResponse)
...
type AuthServer interface {
	...
	Register(context.Context, *RegisterEmail) (*AuthResponse, error)
...
func (UnimplementedAuthServer) Register(context.Context, *RegisterEmail) (*AuthResponse, error) {
...
func _Auth_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).Register(ctx, req.(*RegisterEmail))
	}
	return interceptor(ctx, in, info, handler)
}
